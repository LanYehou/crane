...
def get_boxtype():
    ...
    if most_counterNum[0][0] == 'redcricle' :
        return ('red','cricle')
    elif most_counterNum[0][0] == 'redrectangel' :
        return ('red','rectangel')
    elif most_counterNum[0][0] == 'redtriangel' :
        return ('red','triangel')
    elif most_counterNum[0][0] == 'bluecricle' :
        return ('blue','cricle')
    elif most_counterNum[0][0] == 'bluerectangel' :
        return ('blue','rectangel')
    elif most_counterNum[0][0] == 'bluetriangel' :
